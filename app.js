...
const milestones = [
  ...
  ['1~3강 녹화/음성', '기존 lecture01~03 기반 녹화와 음성 확보', '2026-05-14', '초반 핵심 강의 완료'],
  ['4~8강+P1 녹화', '데이터 자동화 구간 화면녹화/음성 집중', '2026-05-17', 'P1 포함 1차 실습 구간 확보'],
  ['9~12강+P2 음성', '보고서 자동화 구간 녹화본/음성 정리', '2026-05-19', 'P2 포함 보고서 구간 확보'],
  ['13~17강 녹화', '고도화 실무 강의 화면녹화와 음성 확보', '2026-05-21', '본강의 전체 확보'],
  ['최종 확보', 'P3, 전체 검수, 백업, 납품 패키지', '2026-05-22', '전체 녹화본 파일 확보'],
];

const courses = [
  ['1', 'AI 마인드셋 + 엔지니어링 활용 전략', '리허설, 화면녹화, 음성녹음, 편집', '2026-05-12', '2026-05-14', '기존'],
  ['2', '엔지니어용 AI 인터페이스 구성과 대화법', '프롬프트 사례 검수, 화면녹화, 음성녹음', '2026-05-12', '2026-05-15', '기존'],
  ['3', '방대한 MES 데이터 병합 및 요약 자동화', 'CVD/MES 실습 녹화, 음성녹음, 편집', '2026-05-13', '2026-05-15', '기존'],
  ['4', '데이터 정제 마스터: 설비 데이터 노이즈 제거', '샘플 데이터, 화면녹화, 음성녹음', '2026-05-14', '2026-05-17', '강의'],
  ['P1', '자동 데이터 분석기 제작', '과제 안내 녹화, 음성녹음, 평가 체크리스트', '2026-05-15', '2026-05-18', '프로젝트'],
  ['5', '인터랙티브 수율 히트맵 및 웨이퍼 맵 시각화', '히트맵 실습 화면녹화, 음성녹음', '2026-05-15', '2026-05-18', '강의'],
  ['6', '설비 이상 징후 감지 및 실시간 모니터링', 'OOC 대시보드 화면녹화, 음성녹음', '2026-05-16', '2026-05-19', '강의'],
  ['7', '공정 간 상관관계 분석 및 산점도 시각화', '상관분석 녹화, 설명 음성녹음', '2026-05-16', '2026-05-19', '강의'],
  ['8', '불량 원인 Pareto & 트렌드 자동 분석', '파레토 실습 화면녹화, 음성녹음, 편집', '2026-05-17', '2026-05-20', '강의'],
  ['9', '엔지니어용 기술 문서 요약 비서 구축', 'PDF 데모 화면녹화, 음성녹음', '2026-05-18', '2026-05-20', '강의'],
  ['10', '데이터 기반 주간/월간 보고서 자동 생성', '리포트 자동화 녹화, 음성녹음', '2026-05-18', '2026-05-21', '강의'],
  ['P2', '실무 자동화 보고서 앱', '프로젝트 앱 화면녹화, 음성녹음', '2026-05-19', '2026-05-21', '프로젝트'],
  ['11', '공정 파라미터 최적화: 골든 레시피 탐색', '조건 비교 녹화, 음성녹음', '2026-05-19', '2026-05-21', '강의'],
  ['12', 'OLED 광학 및 공정 시뮬레이터 제작', '시뮬레이터 화면녹화, 음성녹음', '2026-05-20', '2026-05-22', '강의'],
  ['13', '이미지 기반 불량 크기 자동 측정 실습', '현미경 이미지 데모 녹화, 음성녹음', '2026-05-20', '2026-05-22', '강의'],
  ['14', '자재 소모량 예측 및 스마트 재고 관리 전산', '예측 화면녹화, 음성녹음, 편집', '2026-05-20', '2026-05-22', '강의'],
  ['15', 'AI 기반 정비 의사결정 및 견적 분석 추천', '견적 비교 녹화, 음성녹음', '2026-05-20', '2026-05-22', '강의'],
  ['16', '팀 협업용 공정 대시보드 최종 통합 실습', '통합 대시보드 녹화, 음성녹음', '2026-05-20', '2026-05-22', '강의'],
  ['17', '현장 엔지니어 특화 AI 활용 시나리오 피칭', '피칭 발표 녹화, 음성녹음', '2026-05-20', '2026-05-22', '강의'],
  ['P3', '최종 실무 과제: 나만의 엔지니어 툴킷', '최종 프로젝트 녹화, 음성녹음, 납품 패키지', '2026-05-20', '2026-05-22', '프로젝트'],
];

const weekly = [
  ['D1-D2', '05/12~05/13', '킥오프, 템플릿 확정, 1~2강 화면녹화/음성녹음', '초반 녹화본 확보'],
  ['D3-D4', '05/14~05/15', '3~5강, P1 화면녹화/음성녹음 집중', '기존 저장소 기반 강의 완료'],
  ['D5-D6', '05/16~05/17', '6~8강 녹화, 음성 재녹음, P1 편집', '데이터 자동화 구간 확보'],
  ['D7-D8', '05/18~05/19', '9~11강, P2 화면녹화/음성녹음', '보고서 자동화 구간 확보'],
  ['D9-D10', '05/20~05/21', '12~17강, P3 녹화/음성녹음 총력 진행', '본강의 전체 1차 확보'],
  ['D11', '05/22', '음성 레벨 재검수, 백업, 최종 납품', '모든 녹화본 파일 확보'],
];
...
const workflow = [
  ...
  ['화면 녹화', '강의 설명, 실습 진행, 결과 화면 캡처, 실패 구간 재녹화', '2.5~3시간'],
  ['음성 녹음', '마이크 레벨, 노이즈 제거, 재녹음 구간 확보, 음량 정규화', '1.5~2시간'],
